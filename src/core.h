...
inline Vec3 barycentric(Vec3 v0, Vec3 v1, Vec3 v2, num px, num py,
                        num denom) {
  num x0 = v0.x, y0 = v0.y;
  num x1 = v1.x, y1 = v1.y;
  num x2 = v2.x, y2 = v2.y;
...
inline num fmin3(num x, num y, num z) {
  return fmin(x, fmin(y, z));
}
inline num fmax3(num x, num y, num z) {
  return fmax(x, fmax(y, z));
}

inline Vec3 bary_precomp(num px, num py,
